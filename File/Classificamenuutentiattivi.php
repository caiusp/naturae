  ...
  <body>
    <div class="sfondo">
      ...
      <div class="contenitore1">
        <h1>Classifica utenti più attivi: </h1><br><br>
        <div class="lista">
        <?php

        $db=mysqli_connect('localhost','root','Nico1998','progetto') or die("Impossibile connettersi al database");

        $result=mysqli_query($db,"SELECT Nome,contatoreAvvistamentiEffettuati as AvvistamentiEffettuati FROM UTENTE ORDER BY contatoreAvvistamentiEffettuati DESC;");
